...
import com.test.facetrack.utils.ImageConvert;
/**
 * OpenCv启动摄像头，进行人脸追踪
 */
public class CameraFace {
	 ...
	 * 加载人脸追踪引擎、窗口,启动摄像头
	 */
	public void Start(FaceTrackingdEngine faceTrackingdEngine) {
		// 启动窗口
		...
		while(flag){
			...
			// 人脸检测
			FaceInfo[] faceInfos = faceTrackingdEngine.doFaceTrace(asv);
			// 如果未检测到人脸则设置圆圈为浅红
		...
		camera.release();
		// 销毁引擎,释放相应资源
		faceTrackingdEngine.uninitialFaceEngine();
	}
